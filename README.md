...
Tab1:addToggle("Auto Farm", false, function(value)
					_G.AutoFarm = value
					ps = value
end)


				local FUNC5 = Tab1:addToggle("Auto Equiq Weapon",false,function(value)
				AutoEquip = value
...
Tab1:addToggle("Bing Mob", false, function(value)
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    for i2,v2 in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v.Name == MON and v2.Name == MON then
                            v2.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame
                            v2.Humanoid.WalkSpeed = 10
